...
class Form
{
    ...
    public function handleSubmit()
    {
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO `tb_ngulang`(`nama`,`rayon`,`rombel`,`nis`,`mtk`, `prod`, `pipas`, `sejarah`, `agama`, `bindo`) VALUES ('$nama','$rayon','$rombel','$nis','$mtk','$prod','$pipas','$sejarah','$agama','$bindo')";
...
?>
<html><a class="a" href="dashboard.php">Tampil</a>
