...
<body>
    <center>
        <form action="" method="post">
            ...
            <h3>Rombel</h3>
            <input type="text" name="rombel" required>
    ...
    class DataHandler
    {
        ...
        public function tambahData($nama,$rayon,$rombel,$nis, $mtk, $prod, $pipas, $sejarah, $agama, $bindo)
        {
            $query = "INSERT INTO tb_ngulang (nama,rayon,rombel,nis, mtk, prod, pipas, sejarah, agama, bindo) VALUES ('$nama','$rayon','$rombel','$nis', '$mtk', '$prod', '$pipas', '$sejarah', '$agama', '$bindo')";
    ...
    if (isset($_POST['submit'])) {
        ...
        $dataHandler->tambahData($nama,$rayon,$rombel,$nis, $mtk, $prod, $pipas, $sejarah, $agama, $bindo);
    }
    ?>
</body>
